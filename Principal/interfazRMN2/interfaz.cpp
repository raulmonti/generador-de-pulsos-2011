...
#define SYSCALL_PARSER_NAME "rmnParser.exe"
...
int nSamples, mps, DDSfreq1, DDSfreq2, ADbufSize, ADMode;
    ...
    if(error == NO_ERROR){
        stringstream *str = new stringstream();
        *str << "PulseSheet: " << pulseSheetPath << endl;
        *str << "DelaysConfig: " << configPath << endl;
        *str << "Mps: " << formPrincipal->campoMuestrasPorSegundo->Text.c_str() << endl;
        *str << "BuffSize: " << getKPC() << endl;
        *str << "OpMode: " << getOpMode() << endl;
        *str << "DDSFreq1: " << formPrincipal->campoDDSFrecuencia1->Text.c_str() << endl;
        *str << "DDSFreq2: " << formPrincipal->campoDDSFrecuencia2->Text.c_str() << endl;
        *str << "OutputAD: " << savePath << endl;
        *str << "Samples: " << formPrincipal->Repeticiones->Text.c_str();
